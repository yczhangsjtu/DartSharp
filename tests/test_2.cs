...
public class Builder {
  ...
  public NodeMetadata collectMetadata(dom.Element e) {
    NodeMetadata meta;
  ...
  public Iterable<BuiltPiece> process() {
    _newTextPiece();
...
Iterable<BuildOp> _prepareParentOps(Iterable<BuildOp> parentParentOps,
